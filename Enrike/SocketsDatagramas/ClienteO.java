...
public class ClienteO{
	public static void main(String[] args){
		try{
			...
			System.out.println("Se recibe objeto con la informacion v1: " + d1.getV1() +
			" v2: " + d1.getV2() + " v3: " + d1.getV3() + " v4: " + d1.getV4());

			Dato d2 = new Dato("cinco", 6, 7.0f, 8);
			System.out.println("Enviando objeto con la informacion v1: " + d2.getV1() +
